...
export default function InboundView({ inventory, onSubmit }) {
  ...
  return (
    <div className="max-w-2xl mx-auto bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
      <div className="p-4 sm:p-6 border-b border-gray-100 bg-emerald-50 text-emerald-800">
      ...
      <form onSubmit={handleSubmit} className="p-4 sm:p-6 space-y-5">
        ...
        <div className="pt-4 border-t border-gray-100 flex flex-col sm:flex-row justify-end gap-3">
          ...
          <button
            ...
            className="px-5 py-2.5 bg-emerald-600 text-white rounded-lg text-sm font-medium hover:bg-emerald-700 disabled:opacity-50 flex items-center justify-center gap-2 w-full sm:w-auto order-1 sm:order-2"
          >
